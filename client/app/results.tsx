...
export default function ResultsScreen() {
  ...
  const missedTerms: string[] = missed ? JSON.parse(missed as string) : [];
  const scoreNum = Number(score);
  const totalNum = Number(total) || scoreNum + missedTerms.length;
      ...
      <View style={styles.scoreCard}>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statBox, { backgroundColor: "#fef9e7" }]}>
            <Text style={styles.statNum}>{missedTerms.length}</Text>
