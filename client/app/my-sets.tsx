      ...
      {sets.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.back()}
          >
            <Text style={styles.goHomeBtnText}>Create Cards →</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <>
...
const styles = StyleSheet.create({
  ...
  emptySubtitle: { fontSize: 14, color: "#888", textAlign: "center", marginBottom: 24, paddingHorizontal: 20 },
  goHomeBtn: { backgroundColor: "#6C63FF", paddingVertical: 12, paddingHorizontal: 24, borderRadius: 10 },
